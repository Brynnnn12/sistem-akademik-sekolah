<x-layout.dashboard title="Tambah Kelas">
    <x-ui.card>
        <x-slot name="header">
        ...
        <form action="{{ route('kelas.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <x-form.input name="nama" placeholder="Contoh: 1A, 6B, 3C" value="{{ old('nama') }}" required
                    maxlength="10" />
